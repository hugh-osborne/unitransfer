classdef burster_basic < handle
    ...
    methods
        function obj = burster_basic(E_l, plt, eff, h)
        ...
        function r = update(obj,dt, t)
            ...
            I_synE = -obj.g_syn * obj.h_synE * (obj.v - obj.E_synE);
            I_synI = -obj.g_syn * -obj.h_synI * (obj.v - obj.E_synI);
            if obj.refracting == 0
                obj.v=obj.v+dt*(I_nap + I_na + I_l + I_k + obj.mlr);
            end
            ...
            tau_synE = 5;
            tau_synI = 5;
            obj.h_synE=obj.h_synE+dt*( (1.0/tau_synE)*(-obj.h_synE + (obj.mlr)) );
            obj.h_synI=obj.h_synI+dt*( (1.0/tau_synI)*(-obj.h_synI) );
            if obj.v>-30 && obj.refracting == 0
                obj.t_last = t;
                obj.refracting = 1; 
                obj.v=-50;
                obj.h_nap=obj.h_nap-0.0004;
                for n = obj.next
                   n.v = n.v - obj.syn_eff;
                    %n.h_synI = n.h_synI - (obj.syn_eff);
                    n.refracting = 0;
                end
            end    
            if obj.refracting
