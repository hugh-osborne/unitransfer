...
for i = 5:strip_cell_strip_width:nullcline_strip_length-(1*strip_cell_strip_width)
    ...
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, 1,i-1, 1.0/strip_cell_strip_width);
    for j = 1:strip_cell_strip_width-2
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, 1,i+j-1, 1.0/strip_cell_strip_width);
    end
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2,1,i+strip_cell_strip_width-1-1, 1.0/strip_cell_strip_width);
...
for i = 5:small_strip_width:((small_strip_start * strip_cell_strip_width)-small_strip_width)+5
    ...
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, 1,i-1, 1.0/small_strip_width);
    for j = 1:small_strip_width-2
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, 1,i+j-1, 1.0/small_strip_width);
    end
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2,1,i+small_strip_width-1-1, 1.0/small_strip_width);
...
for i = 5:small_width:(4*strip_cell_strip_width)-small_width
    ...
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, nullcline_strip_num,i-1, 1.0/small_width);
    for j = 1:small_width-2
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, nullcline_strip_num,i+j-1, 1.0/small_width);
    end
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2,nullcline_strip_num,i+small_width-1-1, 1.0/small_width);
...
for i = (4*strip_cell_strip_width):strip_cell_strip_width:nullcline_strip_length-(strip_cell_strip_width)
    ...
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, nullcline_strip_num,i-1, 1.0/strip_cell_strip_width);
    for j = 1:strip_cell_strip_width-2
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, nullcline_strip_num,i+j-1, 1.0/strip_cell_strip_width);
    end
    fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2,nullcline_strip_num,i+strip_cell_strip_width-1-1, 1.0/strip_cell_strip_width);
...
fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, nullcline_strip_num,i-1, 1.0/final_strip_width);
for j = 1:final_strip_width-2
    fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, nullcline_strip_num,i+j-1, 1.0/final_strip_width);
end
fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2,nullcline_strip_num,i+final_strip_width-1-1, 1.0/final_strip_width);
...
for v0 = v_init:0.1:-60.06
    ...
    if strip == nullcline_strip_attach
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, nullcline_strip_num,0, 1.0);
    else
        fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, strip+num_strips_to_join,0, 1.0);
    end
...
for v0 = v_init:0.1:-60.06
    ...
    fprintf(revId, '%i,%i\t%i,%i\t%f\n',strip, length(svs_1)-2, nullcline_strip_num,reset_cell, 1.0);
...
fprintf(revId, '%i,%i\t%i,%i\t%f\n', strip, length(svs_1)-2, 93, 11, 1.0);
